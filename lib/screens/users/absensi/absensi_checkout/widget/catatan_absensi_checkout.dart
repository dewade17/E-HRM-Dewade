...
class CatatanAbsensiCheckout extends StatefulWidget {
  const CatatanAbsensiCheckout({
    super.key,
    this.onChanged,
  ...
  @override
  State<CatatanAbsensiCheckout> createState() => _CatatanAbsensiCheckoutState();
}

class _CatatanAbsensiCheckoutState extends State<CatatanAbsensiCheckout> {
  ...
  @override
  void didUpdateWidget(covariant CatatanAbsensiCheckout oldWidget) {
