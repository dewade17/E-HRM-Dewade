...
class CalendarRiwayatPocketMoney extends StatefulWidget {
  final DateTime? selectedDay;
  final ValueChanged<DateTime?>? onDaySelected;
  final List<DateTime> markerDates;

  const CalendarRiwayatPocketMoney({
    super.key,
    this.selectedDay,
    this.onDaySelected,
  ...
  @override
  State<CalendarRiwayatPocketMoney> createState() =>
      _CalendarRiwayatPocketMoneyState();
}

class _CalendarRiwayatPocketMoneyState extends State<CalendarRiwayatPocketMoney>
  ...
  @override
  void didUpdateWidget(CalendarRiwayatPocketMoney oldWidget) {
