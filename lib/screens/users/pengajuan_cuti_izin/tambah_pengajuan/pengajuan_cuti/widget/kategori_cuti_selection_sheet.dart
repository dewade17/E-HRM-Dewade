// lib/screens/users/pengajuan_cuti_izin/tambah_pengajuan/widget/kategori_cuti_selection_sheet.dart

import 'dart:async';
import 'package:e_hrm/dto/pengajuan_cuti/kategori_pengajuan_cuti.dart' as dto;
...
typedef KategoriCutiSelectionCallback =
    void Function(dto.Data? selectedKategori);

class KategoriCutiSelectionSheet extends StatefulWidget {
  final KategoriCutiSelectionCallback onKategoriSelected;
  final String? initialSelectedId; // Untuk menandai item yang sudah dipilih

  const KategoriCutiSelectionSheet({
    super.key,
  ...
  @override
  State<KategoriCutiSelectionSheet> createState() =>
      _KategoriCutiSelectionSheetState();
}

class _KategoriCutiSelectionSheetState
    extends State<KategoriCutiSelectionSheet> {
  ...
  void _onSearchChanged() {
    ...
    _debounce = Timer(const Duration(milliseconds: 400), () {
      if (mounted) {
        ...
        context.read<KategoriCutiProvider>().applySearch(
        ...
        child: SizedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              Expanded(
                child: Consumer<KategoriCutiProvider>(
                  builder: (context, provider, _) {
                    ...
                    if (kategoris.isEmpty && !loading) {
                      return Center(
                        child: Text(
                          hasSearchQuery
                              ? 'Kategori Cuti tidak ditemukan.'
                              : 'Tidak ada data Kategori Cuti.',
                    ...
                    return RefreshIndicator(
                      onRefresh: () async {
                        await context.read<KategoriCutiProvider>().refresh();
                      },
                      child: Column(
                        children: [
                              ...
                              child: ListView.separated(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  final bool isThisSelected =
                                      _currentlySelected?.idKategoriCuti ==
                                      kategori.idKategoriCuti;
                                  final bool dimmed =
