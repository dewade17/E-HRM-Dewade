// lib/shared_widget/kategori_cuti_selection_field.dart

import 'package:e_hrm/contraints/colors.dart';
import 'package:e_hrm/dto/pengajuan_cuti/kategori_pengajuan_cuti.dart' as dto;
import 'package:e_hrm/screens/users/pengajuan_cuti_izin/tambah_pengajuan/pengajuan_cuti/widget/kategori_cuti_selection_sheet.dart';

import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class KategoriCutiSelectionField extends StatelessWidget {
  const KategoriCutiSelectionField({
    super.key,
    required this.label,
    this.selectedKategori, // Menerima objek dto.Data
    required this.onKategoriSelected, // Callback mengembalikan dto.Data
    this.hintText = 'Pilih kategori cuti...',
    this.prefixIcon = Icons.description_outlined,
              ...
              return InkWell(
                onTap: () async {
                  await showModalBottomSheet<void>(
                    ...
                    builder: (_) => KategoriCutiSelectionSheet(
                      initialSelectedId: selectedKategori?.idKategoriCuti,
