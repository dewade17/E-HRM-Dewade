// lib/shared_widget/kategori_sakit_selection_field.dart

import 'package:e_hrm/contraints/colors.dart';
import 'package:e_hrm/dto/pengajuan_sakit/kategori_pengajuan_sakit.dart' as dto;
import 'package:e_hrm/screens/users/pengajuan_cuti_izin/tambah_pengajuan/pengajuan_izin_sakit/widget/kategori_sakit_selection_sheet.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class KategoriSakitSelectionField extends StatelessWidget {
  const KategoriSakitSelectionField({
    super.key,
    required this.label,
    this.selectedKategori, // Menerima objek dto.Data
    required this.onKategoriSelected, // Callback mengembalikan dto.Data
    this.hintText = 'Pilih kategori sakit...',
    this.prefixIcon = Icons.medical_services_outlined, // Ikon medis
              ...
              return InkWell(
                onTap: () async {
                  await showModalBottomSheet<void>(
                    ...
                    builder: (_) => KategoriSakitSelectionSheet(
                      initialSelectedId: selectedKategori?.idKategoriSakit,
